...
class AlarmTest {
    ...
    public void checkAllowedNumberOfPersons(ThreatLevel alarmEnum, int numberOfPeople, String expected) {
        // When
        String status = Alarm.getPeopleCapacityStatus(numberOfPeople, alarmEnum);
